...
from tigernix.tests.common import TransactionCase, BaseCase
from tigernix.tools import mute_logger
from tigernix.tools.safe_eval import safe_eval, const_eval, expr_eval
...
class TestSafeEval(BaseCase):
    ...
    @mute_logger('tigernix.tools.safe_eval')
    def test_05_safe_eval_forbiddon(self):
        ...
        with self.assertRaises(ValueError):
            safe_eval("import tigernix", mode="exec")
