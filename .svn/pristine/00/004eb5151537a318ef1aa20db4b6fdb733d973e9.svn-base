...
from tigernix import _, api, exceptions, fields, models, tools, registry, SUPERUSER_ID
from tigernix.osv import expression

from tigernix.tools import pycompat, ustr
from tigernix.tools.misc import clean_context, split_every
   ...
   Only allowed people can contact us at this address.</p>
    ...
    def message_post(self, *,
        ...
        if values['author_id'] and values['message_type'] != 'notification' and not self._context.get('mail_create_nosubscribe'):
            # if self.env['res.partner'].browse(values['author_id']).active:  # we dont want to add tigernixbot/inactive as a follower
    ...
    def message_post_with_view(self, views_or_xmlid, **kwargs):
        ...
        try:
            from tigernix.addons.http_routing.models.ir_http import slug
            values['slug'] = slug
        except ImportError:
    ...
    def _message_auto_subscribe_followers(self, updated_values, default_subtype_ids):
        ...
        with track_visibility set. Since TigernixERP v7 it is considered as being
