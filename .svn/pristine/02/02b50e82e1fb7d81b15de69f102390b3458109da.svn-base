...
class MarketingCampaignTestBase(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.patcher = patch('tigernix.addons.marketing_automation.models.marketing_campaign.Datetime', wraps=Datetime)
        self.patcher2 = patch('tigernix.addons.marketing_automation.models.marketing_participant.Datetime', wraps=Datetime)
