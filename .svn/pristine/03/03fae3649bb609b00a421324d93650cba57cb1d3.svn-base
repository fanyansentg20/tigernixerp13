tigernix.define('account.upload.bill.mixin', function (require) {
"use strict";
...
tigernix.define('account.bills.tree', function (require) {
"use strict";
    var core = require('web.core');
...
tigernix.define('account.dashboard.kanban', function (require) {
"use strict";
    var core = require('web.core');
