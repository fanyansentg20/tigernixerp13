tigernix.define('web.dom_ready', function (require) {
'use strict';
...
tigernix.define('web.dom', function (require) {
"use strict";
 ...
 * functionalities with the TigernixERP framework.  A common theme in these functions
...
var dom = {
    ...
    /**
     * Renders a button with standard TigernixERP template. This does not use any xml
    ...
    /**
     * Renders a checkbox with standard TigernixERP/BS template. This does not use any
