...
from tigernix.addons.payment_buckaroo.controllers.main import BuckarooController
from tigernix.tools import mute_logger


@tigernix.tests.tagged('post_install', '-at_install', 'external', '-standard')
...
class BuckarooForm(BuckarooCommon):
    ...
    @mute_logger('tigernix.addons.payment_buckaroo.models.payment', 'ValidationError')
    def test_20_buckaroo_form_management(self):
        ...
        buckaroo_post_data = {
            ...
            'BRQ_SERVICE_PAYPAL_PAYEREMAIL': u'fhe@tigernix.com',
