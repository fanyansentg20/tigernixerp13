tigernix.define('account_reports.account_report', function (require) {
'use strict';
...
var accountReportsWidget = AbstractAction.extend({
    ...
    init: function(parent, action) {
        ...
        this.tigernix_context = action.context;
    ...
    parse_reports_informations: function(values) {
        ...
        this.tigernix_context = values.context;
    ...
    trigger_action: function(e) {
        ...
        var context = new Context(this.tigernix_context, params.actionContext || {}, {active_id: id});
