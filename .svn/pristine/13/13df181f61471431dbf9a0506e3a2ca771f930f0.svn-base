...
from tigernix.addons.test_mail.tests import common
from tigernix.addons.test_mail.tests.common import mail_new_test_user
from tigernix.exceptions import AccessError, except_orm
...
class TestMessageValues(common.BaseFunctionalTest, common.MockEmails):
    ...
    def test_mail_message_values_document_alias(self):
        ...
        self.assertIn('-tigernixerp-%d-mail.test' % self.alias_record.id, msg.message_id.split('@')[0])
    ...
    def test_mail_message_values_document_no_alias(self):
        ...
        self.assertIn('-tigernixerp-%d-mail.test.simple' % test_record.id, msg.message_id.split('@')[0])
...
class TestMessageAccess(common.BaseFunctionalTest, common.MockEmails):
    ...
    @mute_logger('tigernix.addons.base.models.ir_model')
    ...
    @mute_logger('tigernixerp.addons.mail.models.mail_mail')
