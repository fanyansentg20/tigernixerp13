...
from tigernix.addons.account_consolidation.tests.account_consolidation_test_classes import AccountConsolidationTestCase
from tigernix.addons.account_consolidation.report.builder.comparison import ComparisonBuilder
from tigernix.addons.account_consolidation.report.builder.comparison import ComparisonBuilder
from tigernix.addons.account_consolidation.report.builder.default import DefaultBuilder
...
class TestAbstractBuilder(AccountConsolidationTestCase):
    ...
    @patch('tigernix.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._get_hierarchy')
    @patch('tigernix.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._get_plain')
    ...
    @patch('tigernix.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._handle_accounts')
    @patch('tigernix.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._build_total_line')
    ...
    @patch('tigernix.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._handle_orphan_accounts')
    @patch('tigernix.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._get_root_sections')
    @patch('tigernix.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._handle_sections')
    @patch('tigernix.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._build_total_line')
    ...
    @patch('tigernix.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._build_section_line')
    @patch(
        'tigernix.addons.account_consolidation.report.handler.show_zero.ShowZeroHandler.section_line_should_be_added',
        return_value=True)
    ...
    @patch('tigernix.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._get_orphan_accounts')
    @patch('tigernix.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._handle_accounts')
    ...
    @patch('tigernix.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._compute_account_totals')
    @patch('tigernix.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._format_account_line')
    @patch('tigernix.addons.account_consolidation.report.handler.show_zero.ShowZeroHandler.account_line_should_be_added',
           return_value=True)
...
class TestComparisonBuilder(AccountConsolidationTestCase):
    ...
    @patch('tigernix.addons.account_consolidation.report.handler.show_zero.ShowZeroHandler.section_line_should_be_added',
           return_value=True)
    @patch('tigernix.addons.account_consolidation.report.handler.show_zero.ShowZeroHandler.account_line_should_be_added',
           return_value=True)
    @patch('tigernix.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._compute_account_totals')
    ...
    @patch('tigernix.addons.account_consolidation.report.builder.comparison.ComparisonBuilder._build_percentage_column',
