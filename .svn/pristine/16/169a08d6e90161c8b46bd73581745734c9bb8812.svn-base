...
class _LogTracer(object):
    ...
    def tracer(self, frame, event, arg):
        ...
        if not isinstance(in_self, tigernix.models.BaseModel):
            return self.tracer
...
def profile(method=None, whitelist=None, blacklist=(None,), files=None,
    ...
    """
        ...
        all methods for all tigernix models by applying the optional filters.
        ...
        :param list blacklist: list model names to remove from the log
                        (Default: remove non tigernix model from the log: [None])
        ...
        .. code-block:: python
          ...
          from tigernix.tools.profiler import profile
          ...
          class SaleOrder(models.Model):
            ...
            ...
            @profile()                  # log all methods for all tigernix models
            def unlink(self):
            ...
            @profile(whitelist=['sale.order', 'ir.model.data'])
            def action_quotation_send(self):
            ...
            @profile(files=['/home/tigernixerp/tigernix/tigernix/addons/sale/models/sale.py'])
            def write(self):
            ...
    ...
    def _tigernixProfile(method, *args, **kwargs):
    ...
    if not method:
        return lambda method: decorator(_tigernixProfile, method)

    wrapper = decorator(_tigernixProfile, method)
    return wrapper
