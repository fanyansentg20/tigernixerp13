...
from tigernix import exceptions, _
from tigernix.http import Controller, request, route
from tigernix.addons.bus.models.bus import dispatch


class BusController(Controller):
    """ Examples:
    tigernixerp.jsonRpc('/longpolling/poll','call',{"channels":["c1"],last:0}).then(function(r){console.log(r)});
    tigernixerp.jsonRpc('/longpolling/send','call',{"channel":"c1","message":"m1"});
    tigernixerp.jsonRpc('/longpolling/send','call',{"channel":"c2","message":"m2"});
    """
