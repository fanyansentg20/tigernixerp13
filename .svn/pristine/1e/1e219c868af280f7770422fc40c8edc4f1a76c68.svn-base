tigernix.define('mail_bot.systray.MessagingMenuTests', function (require) {
"use strict";
...
QUnit.test('messaging menu widget: rendering with TigernixBot has a request', async function (assert) {
    assert.expect(5);
    ...
    assert.strictEqual(messagingMenu.$('.o_preview_name').text().trim(),
        'TigernixBot has a request',
        "preview should display that TigernixBot has a request");
...
QUnit.test('messaging menu widget: rendering without TigernixBot has a request (denied)', async function (assert) {
    assert.expect(3);
...
QUnit.test('messaging menu widget: rendering without TigernixBot has a request (accepted)', async function (assert) {
    assert.expect(3);
