...
from tigernix import api, fields, models, SUPERUSER_ID, _
from tigernix.osv import expression
from tigernix.tools import DEFAULT_SERVER_DATETIME_FORMAT
from tigernix.tools.float_utils import float_compare, float_is_zero, float_round
from tigernix.exceptions import UserError
from tigernix.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        ...
        help="If this checkbox is ticked, TigernixERP will automatically pre-fill the detailed "
