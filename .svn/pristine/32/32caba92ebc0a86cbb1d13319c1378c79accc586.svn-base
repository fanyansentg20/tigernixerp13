...

{
    ...
    'description': """
Import your Amazon orders in TigernixERP and synchronize deliveries
===================================================================

Key Features
------------
* Import orders from multiple accounts and marketplaces.
* Orders are matched with TigernixERP products based on their internal reference (SKU in Amazon).
* Deliveries and cancellations made in TigernixERP are synchronized in Amazon.
