...
from tigernix.tests import TransactionCase, tagged, Form
from tigernix.tools import frozendict, image_to_base64, hex_to_rgb
...
class TestBaseDocumentLayoutHelpers(TransactionCase):
    ...
    def _get_images_for_test(self):
        return ['overwatch.jpg', 'tigernix.jpg']
...
class TestBaseDocumentLayout(TestBaseDocumentLayoutHelpers):
    ...
    def test_company_no_color_but_logo_change_logo(self):
        ...
        with Form(self.env['base.document.layout']) as doc_layout:
            ...
            doc_layout.logo = self.company_imgs['tigernix']['img']
            self.assertColors(doc_layout, self.company_imgs['tigernix']['colors'])
