...
from tigernix.modules.module import get_module_resource
from tigernix.addons.resource.models.resource_mixin import timezone_datetime
...
class HrEmployeePrivate(models.Model):
    ...
    def _post_author(self):
        ...
        by super user. However, tracking messages should not be posted as TigernixBot
