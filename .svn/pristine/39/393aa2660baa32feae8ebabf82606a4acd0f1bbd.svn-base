tigernix.define('web.ControlPanelModel', function (require) {
"use strict";
...
var ControlPanelModel = mvc.Model.extend({
    ...
    _getFilterContext: function (filter) {
        ...
        // https://github.com/tigernix/tigernix/blob/12.0/addons/web/static/src/js/views/search/search_inputs.js#L498
        ...
        if (filter.type === 'field' && filter.isDefault) {
            if (this.fields[filter.attrs.name].type === 'many2one') {
                ...
                // https://github.com/tigernix/tigernix/blob/12.0/addons/web/static/src/js/views/search/search_inputs.js#L461)
