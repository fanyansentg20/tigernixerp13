...
from tigernix.exceptions import AccessError, ValidationError, MissingError
from tigernix.tools import config, human_size, ustr, html_escape
...
class IrAttachment(models.Model):
    """Attachments are used to link binary files or url to any tigernixerp document.
