...
from tigernix.tests.common import TransactionCase, Form
...
class TestSaleMrpProcurement(TransactionCase):
    ...
    def test_sale_mrp(self):
        ...
        # In order to test the sale_mrp module in TigernixERP, I start by creating a new product 'Slider Mobile'
        # I define product category Mobile Products Sellable.

        with mute_logger('tigernix.tests.common.onchange'):
