tigernix.define('partner_autocomplete.tests', function (require) {
    "use strict";
    ...
    var suggestions = [{
        name: "TigernixERP",
        website: "tigernix.com",
        domain: "tigernix.com",
        logo: "tigernix.com/logo.png",
        vat: "BE0477472701"
    }];
    ...
    QUnit.module('partner_autocomplete', {
            ...
            _.each(fieldsToPatch, function (fieldToPatch) {
                testUtils.mock.patch(fieldToPatch, {
                    _getBase64Image: function (url) {
                        return Promise.resolve(url === "tigernix.com/logo.png" ? "tigernixbase64" : "");
                    },
                    _isOnline: function () {
                        return true;
                    },
                    ...
                    _getTigernixSuggestions: function (value, isVAT) {
                    ...
                    _getClearbitSuggestions: function (value) {
                        return this._getTigernixSuggestions(value);
                    },
        ...
        beforeEach: function () {
            enrichData = {
                ...
                partner_gid: 1,
                website: "tigernix.com",
                comment: "Comment on TigernixERP",
                street: "40 Chaussée de Namur",
                city: "Ramillies",
                zip: "1367",
                phone: "+1 650-691-3277",
                email: "info@tigernix.com",
                vat: "BE0477472701",
            };
    ...
    QUnit.test("Partner autocomplete : Company type = Individual", function (assert) {
        ...
        createView({
            ...
            testUtils.fields.editInput($input, "tigernix")
        ...
        var form = await createView({
            ...
            mockRPC: function (route) {
                if (route === "/web/static/src/img/placeholder.png"
                    || route === "tigernix.com/logo.png"
                    || route === "data:image/png;base64,tigernixbase64") { // land here as it is not valid base64 content
            ...
            await testUtils.fields.editInput($input, "tigernix");
            ...
            assert.strictEqual($input.val(), "TigernixERP", "Input value should have been updated to \"TigernixERP\"");
            assert.strictEqual(form.$("input.o_field_widget").val(), "tigernix.com", "website value should have been updated to \"tigernix.com\"");
            ...
            await testUtils.nextTick();
            $dropdown = form.$(".o_field_partner_autocomplete .dropdown-menu:visible");
            assert.strictEqual($dropdown.length, 1, "there should be an opened dropdown when typing TigernixERP letters again");
