tigernix.define('web.search_bar_autocomplete_sources_registry', function (require) {
"use strict";
...
tigernix.define('web._search_bar_autocomplete_sources_registry', function(require) {
"use strict";
