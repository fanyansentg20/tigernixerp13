...
from tigernix.addons.base.models import res_users as ru
...
class pos_config(models.Model):
    ...
    blackbox_pos_production_id = fields.Char("Registered IoT Box serial number",
        help='e.g. BODO001... The IoT Box must be certified by TigernixERP to be used with the blackbox.',
        copy=False)
...
class pos_order(models.Model):
    ...
    pos_version = fields.Char(help="Version of TigernixERP that created the order")
    pos_production_id = fields.Char(help="Unique ID of TigernixERP that created this order")
...
class pos_order_pro_forma(models.Model):
    ...
    pos_version = fields.Char(help="Version of TigernixERP that created the order", readonly=True)
    pos_production_id = fields.Char(help="Unique ID of TigernixERP that created this order", readonly=True)
