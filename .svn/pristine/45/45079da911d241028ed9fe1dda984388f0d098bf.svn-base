...
class TestWebsiteResetViews(tigernix.tests.HttpCase):
    ...
    @mute_logger('tigernix.addons.http_routing.models.ir_http')
    ...
    # @mute_logger('tigernix.addons.http_routing.models.ir_http', 'tigernix.addons.website.models.ir_ui_view')
