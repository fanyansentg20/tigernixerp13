tigernix.define('web.AbstractWebClient', function (require) {
"use strict";
...
var AbstractWebClient = Widget.extend(ServiceProviderMixin, KeyboardNavigationMixin, {
    ...
    init: function (parent) {
        // a flag to determine that TigernixERP is fully loaded
        tigernix.isReady = false;
        this.client_options = {};
        this._super(parent);
        ...
        this.set('title_part', {"ztigernixerp": "TigernixERP"});
    },
    start: function () {
        var self = this;
