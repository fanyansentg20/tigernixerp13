tigernix.define('web_studio.ViewEditorManager_tests', function (require) {
"use strict";
...
QUnit.module('ViewEditorManager', {
    ...
    QUnit.test('search existing fields into sidebar', async function (assert) {
        ...
        const tigernixCurrentDebugValue = tigernix.debug;
        ...
        tigernix.debug = tigernixCurrentDebugValue;
    ...
    QUnit.test('widget dropdown in list editor sidebar', async function (assert) {
        ...
        const originalTigernixDebug = tigernix.debug;
        tigernix.debug = false;
        ...
        tigernix.debug = originalTigernixDebug;
        vem.destroy();
    });
    ...
    QUnit.test('open XML editor in read-only', async function (assert) {
        ...
        var initialDebugMode = tigernix.debug;
        tigernix.debug = true;
        ...
        XMLEditorDef.then(function () {
            ...
            tigernix.debug = initialDebugMode;
