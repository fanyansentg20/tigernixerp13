...
from tigernix.tools import html_escape as escape, posix_to_ldml, safe_eval, float_utils, format_date, format_duration, pycompat
...
def html_escape(string, options):
    ...
    #===============
    #Modified on 23 Feb 2023 by Kevin, reviewed by Erwina
    #Fix issue where print narrow non-break space that will resulting with no space. It should be treated as normal space.
