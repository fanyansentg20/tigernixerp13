tigernix.define('web_studio.tour', function (require) {
"use strict";
...
tour.register('web_studio_home_menu_background_tour', {
    ...
    content: _t('Want to customize the background? Let’s activate <b>TigernixERP Studio</b>.'),
    position: 'bottom',
...
tour.register('web_studio_new_app_tour', {
    ...
    content: _t("Let’s check the result. Close TigernixERP Studio to get an <b>overview of your app</b>."),
    position: 'left',
}, {
    ...
    content: _t("Wow, nice! And I’m sure you can make it even better! Use this icon to open <b>TigernixERP Studio</b> and customize any screen."),
    position: 'bottom',
}, {
