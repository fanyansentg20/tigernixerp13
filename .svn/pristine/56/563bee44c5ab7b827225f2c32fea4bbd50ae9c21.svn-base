...
from tigernix.tests.common import TransactionCase, can_import
from tigernix.modules.module import get_module_resource
from tigernix.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('tigernix.addons.base_import.models.base_import')
