...
#
#    Deze module werkt in TigernixERP 5.0.0 (en waarschijnlijk hoger).
#    Deze module werkt niet in TigernixERP versie 4 en lager.
#
#    Status 1.0 - getest op TigernixERP 5.0.3
#
# Versie 5.0.0.1
