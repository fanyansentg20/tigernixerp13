tigernix.define('web.ActionManager', function (require) {
"use strict";
 ...
 * Its role is to makes sure that TigernixERP actions are properly started and
 * coordinated.
 */
...
var ActionManager = Widget.extend({
    ...
    /**
     * This is the entry point to execute TigernixERP actions, given as an ID in
     ...
     * @param {TigernixEvent} ev.data.controllerID
     */
