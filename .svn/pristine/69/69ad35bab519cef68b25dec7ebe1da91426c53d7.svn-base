...
import tigernix
from tigernix.tests import common, tagged
from tigernix.tools.misc import file_open, mute_logger
from tigernix.tools.translate import _, _lt
...
class TestTermCount(common.TransactionCase):
    ...
    def test_count_term(self):
        ...
        """
        tigernix.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_FR', module_name='test_translation_import', verbose=False)
    ...
    def test_count_term_module(self):
        ...
        """
        tigernix.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_FR', verbose=False)
        translations = self.env['ir.translation'].search([
            ('lang', '=', 'fr_FR'),
            ('src', '=', 'Ijkl'),
    ...
    def test_noupdate(self):
        ...
        tigernix.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_FR', module_name='test_translation_import', verbose=False, context={'overwrite': True})
    ...
    def test_lang_with_base(self):
        tigernix.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_BE', module_name='test_translation_import', verbose=False)
        tigernix.tools.trans_load(self.cr, 'test_translation_import/i18n/fr_BE.po', 'fr_BE', module_name='test_translation_import', verbose=False, context={'overwrite': True})
    ...
    def test_export_empty_string(self):
        ...
        def update_translations(context=None):
            ...
            with closing(io.BytesIO()) as bufferobj:
                tigernix.tools.trans_export('fr_FR', ['test_translation_import'], bufferobj, 'po', self.cr)
                bufferobj.name = 'test_translation_import/i18n/fr.po'
                tigernix.tools.trans_load_data(self.cr, bufferobj, 'po', 'fr_FR', verbose=False, context=context)
    ...
    def test_import_from_po_file(self):
        ...
        with mute_logger('tigernix.addons.base.models.res_lang'):
...
class TestTranslationFlow(common.TransactionCase):
    ...
    def test_export_import(self):
        ...
        with mute_logger('tigernix.addons.base.models.ir_translation'):
