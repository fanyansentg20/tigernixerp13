tigernix.define('web_studio.reportEditComponents', function (require) {
"use strict";
...
var AbstractEditComponent = Abstract.extend(StandaloneFieldManagerMixin, {
    ...
    _onDirectiveChange: function (e) {
        var self = this;
        e.stopPropagation();  // TODO: is it really useful on an TigernixERPEvent
...
var TIf = AbstractEditComponent.extend({
    ...
    start: function () {
        ...
        try {
            ...
            console.warn("Can't convert the condition in an TigernixERP domain", this.node.attrs['t-if'], e);
