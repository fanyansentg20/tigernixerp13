...
from tigernix.exceptions import ValidationError, UserError, except_orm
    ...
    def unlink(self):
        if self.env['account.move'].sudo().search(
            ...
            raise UserError(_(
                ...
                'Expired Certificates will not be used as TigernixERP uses the latest valid certificate. '
