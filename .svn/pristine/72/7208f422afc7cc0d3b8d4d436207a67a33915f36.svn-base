...
from tigernix.modules import load_information_from_description_file
from tigernix.tools import convert_file, exception_to_unicode
from tigernix.tools.osutil import tempdir
...
class IrModule(models.Model):
    ...
    def _import_module(self, module, path, force=False):
        ...
        if unmet_dependencies:
            ...
            raise UserError(_("Studio customizations require the TigernixERP Studio app."))
    ...
    def import_zipfile(self, module_file, force=False):
        ...
        with zipfile.ZipFile(module_file, "r") as z:
            ...
            with tempdir() as module_dir:
                import tigernix.modules.module as module
                try:
                    tigernix.addons.__path__.append(module_dir)
                    ...
                    tigernix.addons.__path__.remove(module_dir)
