...
from tigernix.modules import get_module_path, get_module_resource
...
class IrTranslation(models.Model):
    ...
    # aka gettext extracted-comments - we use them to flag tigernixerp-web translation
    ...
    def get_translations_for_webclient(self, mods, lang):
        ...
        messages = self.env['ir.translation'].sudo().search_read([
            ...
            ('comments', 'like', 'tigernixerp-web'), ('value', '!=', False),
            ('value', '!=', '')],
