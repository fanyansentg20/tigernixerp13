...
class TestUiCustomizeTheme(tigernix.tests.HttpCase):
...
@tigernix.tests.tagged('-at_install', 'post_install')
class TestUiHtmlEditor(tigernix.tests.HttpCase):
...
@tigernix.tests.tagged('-at_install', 'post_install')
class TestUiTranslate(tigernix.tests.HttpCase):
...
class TestUi(tigernix.tests.HttpCase):
    ...
    def test_01_public_homepage(self):
        self.phantom_js("/", "console.log('test successful')", "'website.content.snippets.animation' in tigernix.__DEBUG__.services")
