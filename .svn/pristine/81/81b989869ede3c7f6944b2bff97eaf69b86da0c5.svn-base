tigernix.define('stock_barcode.inventory_client_action', function (require) {
'use strict';
...
var InventoryClientAction = ClientAction.extend({
    ...
    /**
     * Handles the `validate` TigernixERPEvent.
     *
     * @private
    ...
    /**
    * Handles the `cancel` TigernixERPEvent.
    *
    * @private
    * @param {TigernixEvent} ev
    */
    ...
    /**
     * Handles the `print_inventory` TigernixERPEvent. It makes an RPC call
