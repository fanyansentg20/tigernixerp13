...
from tigernix import _, api, fields, models
from tigernix.tools import DEFAULT_SERVER_TIME_FORMAT
from tigernix.tools.float_utils import float_compare
from tigernix.tools.misc import html_escape
...
class AccountPayment(models.Model):
    ...
    def l10n_mx_edi_is_required(self):
        ...
        if self.invoice_ids and not self.invoice_ids.filtered(
            ...
            messages.append(_(
                ...
                '<a href="https://www.tigernix.com/documentation/user/11.0/es/accounting/localizations/mexico.html#payments-just-available-for-cfdi-3-3">'
                'TigernixERP documentation</a> to know how to indicate the payment '
    ...
    def l10n_mx_edi_update_pac_status(self):
        """Synchronize both systems: TigernixERP & PAC if the invoices need to be
        signed or cancelled."""
        # TODO - Duplicated
        for record in self:
