tigernix.define('social_push_notifications.social_push_preview', function (require) {
'use strict';
...
var PushPreviewButton = Widget.extend({
     ...
     *
     * If the image has not been set, will use the default fallback (tigernixbot image).
     *
    ...
    _getImageUrl(recordImage) {
        ...
        return '/mail/static/src/img/tigernixbot_transparent.png';
    }
});
