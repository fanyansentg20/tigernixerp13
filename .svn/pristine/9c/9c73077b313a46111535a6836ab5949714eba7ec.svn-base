...
if DEBUG:
    ...
    PROXY_SERVER = 'https://www.test.tigernix.com'
else:
    HMRC_CLIENT_ID = 'GqJgi8Hal1hsEwbG6rY6i9Ag1qUa'
    PROXY_SERVER = 'https://onlinesync.tigernix.com'
TIMEOUT = 10
...
class HmrcService(models.AbstractModel):
    ...
    def _get_fraud_prevention_info(self):
        ...
        try:
            ...
            gov_dict['Gov-Vendor-Version'] = "Tigernix=" + urls.url_quote(gov_vendor_version)
            ...
            if hashed_license:
                gov_dict['Gov-Vendor-License-IDs'] = "Tigernix=" + hashed_license
        except Exception:
