...
from tigernix.addons.event.tests.common import TestEventCommon
from tigernix.exceptions import ValidationError, UserError, AccessError
...
class TestEventFlow(TestEventCommon):
    ...
    def test_event_date_range(self):
        self.event_0.write({'registration_ids': [(0, 0, {'partner_id': self.user_eventuser.partner_id.id})]})
        self.patcher = patch('tigernix.addons.event.models.event.fields.Datetime', wraps=Datetime)
