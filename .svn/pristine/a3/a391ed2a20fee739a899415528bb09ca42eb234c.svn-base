...
from tigernix.tools import misc, mute_logger
...
class InvoiceTransactionCase(AccountingTestCase):
    ...
    def _validate_and_compare(self, invoice, invoice_number, filename_expected):
        ...
        with patch('tigernix.addons.l10n_co_edi.models.carvajal_request.CarvajalRequest.upload', new=Mock(return_value=return_value)):
            invoice.post()
    ...
    def test_invoice(self):
        ...
        with mute_logger('tigernix.addons.account.models.account_invoice'):
