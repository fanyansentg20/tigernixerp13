...
from tigernix.exceptions import ValidationError, AccessError
from tigernix.addons.base.models.res_bank import sanitize_account_number
from tigernix.addons.base_iban.models.res_partner_bank import validate_iban
...
class PaymentTxSepaDirectDebit(models.Model):
    ...
    def _notify_debit(self, mandate):
        ...
        TigernixERP will send the notifications during transaction creation.
        """
