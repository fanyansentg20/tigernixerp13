tigernix.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in TigernixERP.
 *
 * The basic concurrency primitives in TigernixERP JS are the callback, and the
...
return {
    ...
    /**
     * A (TigernixERP) mutex is a primitive for serializing computations.  This is
