...
from tigernix import api, fields, models, SUPERUSER_ID, tools
from tigernix.addons.resource.models.resource import float_to_time, HOURS_PER_DAY
from tigernix.exceptions import AccessError, UserError, ValidationError
from tigernix.tools import float_compare
from tigernix.tools.float_utils import float_round
    ...
    def create(self, values):
        ...
        if not self._context.get('leave_fast_create'):
            ...
            if leave_type.validation_type == 'no_validation':
                ...
                holiday_sudo.message_post(body=_("The time off has been automatically approved"), subtype="mt_comment") # Message from TigernixBot (sudo)
