tigernix.define('web_editor.tour', function (require) {
'use strict';
...
tour.register('rte', {
    ...
    run: function () {
        var html = '\n'+
            ...
            '        </div>\n'+
            '        <div class="col-lg-6 mt16">\n'+
            '            <img class="img img-fluid shadow mb16" src="/web/static/src/img/logo.png" alt="TigernixERP text and image block">\n'+
            '        </div>\n'+
            '    </div>\n'+
            '</section>\n';
    ...
    run: "text http://www.tigernix.com",
}, {
...
tour.register('rte_inline', {
    ...
    run: function () {
        var html = '\n'+
            ...
            '        </td>\n'+
            '        <td valign="center" width="270">\n'+
            '          <a href="https://www.facebook.com/TigernixERP"><span class="fa fa-facebook-square fa-2x text-primary"></span></a>\n'+
