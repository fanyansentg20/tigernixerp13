define(['summernote/core/range', 'summernote/core/dom'], function (range, dom) { // TIGERNIX: suggest upstream
  /**
  ...
  var History = function ($editable) {
    ...
    var makeSnapshot = function () {
      ...
      return {
        ...
        // TIGERNIX: suggest upstream added " && dom.ancestor(rng.sc, dom.isEditable) "
      };
    };
    ...
    var last; // TIGERNIX: to suggest upstream (since we may have several editor)
    /**
     * recorded undo
     */
    this.recordUndo = function () {
      // TIGERNIX: method totally rewritten
