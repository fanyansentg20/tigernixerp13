tigernix.define('account_batch_payment.reconciliation_tests.data', function (require) {
"use strict";
...
tigernix.define('account_batch_payment.reconciliation_tests', function (require) {
"use strict";
