...
from tigernix import exceptions, tests
from tigernix.addons.test_mail.tests.common import BaseFunctionalTest
from tigernix.addons.test_mail.models.test_mail_models import MailTestActivity
