...
from tigernix.tools import DEFAULT_SERVER_DATE_FORMAT, DEFAULT_SERVER_DATETIME_FORMAT, date_utils
...
class PlaidProviderAccount(models.Model):
    ...
    def plaid_fetch(self, url, data):
        ...
        try:
            ...
            # This is only intended to work with TigernixERP proxy, if user wants to use his own plaid account
