...
"""The TigernixERP API module defines TigernixERP Environments and method decorators.
...
from tigernix.tools import frozendict, classproperty, lazy_property, StackMap
from tigernix.exceptions import CacheMiss
...
#  - method._ondelete: set by @ondelete, specifies ondelete functions.
...
def constrains(*args):
    ...
    Should raise :exc:`~tigernix.exceptions.ValidationError` if the
    validation failed.
...
def ondelete(*, at_uninstall: bool):
    """
...
def onchange(*args):
    ...
    .. warning::
        ...
        itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/tigernix/tigernix/issues/2693>`_.
...
def autovacuum(method):
    """
    Decorate a method so that it is called by the daily vacuum cron job ``ir.autovacuum``, which
    typically used for garbage-collection-like-tasks that do not deserve a specific cron job.
    """
...
class Environment(Mapping):
    ...
    def __call__(self, cr=None, user=None, context=None, su=None):
        """ Return an environment based on ``self`` with modified parameters.
            ...
            :type context: dict
            :type user: int or :class:`~tigernix.addons.base.models.res_users`
            :type su: bool
        """
    ...
    def user(self):
        ...
        :rtype: :class:`~tigernix.addons.base.models.res_users`"""
...
from tigernix.exceptions import UserError, AccessError, MissingError
