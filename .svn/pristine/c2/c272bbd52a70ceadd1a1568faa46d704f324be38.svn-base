...
If you use the external timesheet application, this module alows you to synchronize timesheet entries between TigernixERP and the application.
    """,
    'website': 'https://www.tigernix.com/page/project-management',
