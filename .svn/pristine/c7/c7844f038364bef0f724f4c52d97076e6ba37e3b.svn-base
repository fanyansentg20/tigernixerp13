...
The eBay integrator gives you the opportunity to manage your TigernixERP's products on eBay.
...
* Automatic creation of sales order and invoices
  ...
  # Check https://github.com/tigernix/tigernix/blob/master/tigernix/addons/base/data/ir_module_category_data.xml
  # for the full list
