...
forget an event, fully synchronized with the TigernixERP <a href="https://www.tigernix.com/page/crm">Open Source CRM</a>.
...
You can ask to have a alarm of type 'notification' in your TigernixERP.  You will have
a notification in you TigernixERP which ever the page you are.

Google Calendar
---------------

With this plugin, you can synchronize your TigernixERP calendar with Google Calendar.
