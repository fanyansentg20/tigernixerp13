tigernix.define('sign.PDFIframe', function (require) {
    'use strict';
...
tigernix.define('sign.Document', function (require) {
    'use strict';
...
tigernix.define('sign.utils', function (require) {
    'use strict';
...
// Signing part
tigernix.define('sign.document_signing', function (require) {
    'use strict';
