tigernix.define('mail.mail_utils_tests', function (require) {
"use strict";
...
QUnit.test('add_link utility function', function (assert) {
    ...
    var testInputs = {
        ...
        "https://www.transifex.com/tigernix/tigernix-11/translate/#fr/lunch?q=text%3A'La+Tartiflette'": true,
        'https://www.transifex.com/tigernix/tigernix-11/translate/#fr/$/119303430?q=text%3ATartiflette': true,
    };
