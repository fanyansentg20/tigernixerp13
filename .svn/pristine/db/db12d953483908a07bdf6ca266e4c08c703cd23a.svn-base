tigernix.define('pos_blackbox_be.pos_blackbox_be', function (require) {
...
can no longer be modified. Please create a new line with eg. a negative quantity."),
    ...
    models.PosModel = models.PosModel.extend({
            ...
            var prom = this.proxy.request_fdm_hash_and_sign(packet).then(function (parsed_response) {
                return new Promise(function (resolve, reject) {
                    if (parsed_response) {
                        ...
                        order.blackbox_pos_version = "TigernixERP " + self.version.server_version + "1807BE_FDM";
        ...
        get_blackbox_terminal_id: function () {
            if (! localStorage['tigernix_pos_blackbox_pos_production_id']) {
                ...
                localStorage['tigernix_pos_blackbox_pos_production_id'] = production_id;
            }

            return localStorage['tigernix_pos_blackbox_pos_production_id'];
        },
