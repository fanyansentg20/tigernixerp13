...
from tigernix.exceptions import AccessError, except_orm, ValidationError, UserError
...
class TestChannelAccessRights(common.BaseFunctionalTest, common.MockEmails):
    ...
    @mute_logger('tigernix.addons.base.models.ir_model', 'tigernix.models', 'tigernix.models.unlink')
...
class TestChannelModeration(common.Moderation):
    ...
    @mute_logger('tigernix.addons.mail.models.mail_channel', 'tigernix.models.unlink')
