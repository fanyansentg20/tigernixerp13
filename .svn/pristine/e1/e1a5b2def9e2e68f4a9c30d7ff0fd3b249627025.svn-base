tigernix.define('web.UserMenu', function (require) {
"use strict";
...
var UserMenu = Widget.extend({
            ...
            callback: function () {
                self._rpc({route: '/web/session/account'})
                    ...
                    .guardedCatch(function (result, ev){
                        ev.preventDefault();
                        framework.redirect('https://accounts.tigernix.com/account');
                    });
            },
        });
    },
    ...
    _onMenuDocumentation: function () {
        window.open('https://www.tigernix.com/documentation/user', '_blank');
    },
    /**
     * @private
     */
    ...
    _onMenuSupport: function () {
        window.open('https://www.tigernix.com/buy', '_blank');
    },
    /**
     * @private
     */
