tigernix.define('documents.documents_kanban_tests', function (require) {
"use strict";
...
QUnit.module('DocumentsKanbanView', {
    ...
    QUnit.test('documents Kanban: displays youtube thumbnails', async function (assert) {
        ...
        this.data['documents.document'].records.push({
            ...
            name: 'youtubeVideo',
            type: 'url',
            url: 'https://www.youtube.com/watch?v=Bt7bP6n8P20'
        });
        ...
        assert.strictEqual(
            ...
            "https://image4.owler.com/logo/tigernix_owler_20190204_212234_original.jpg",
