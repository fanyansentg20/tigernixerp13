...
spec = importlib.util.spec_from_file_location("tigernix.upgrades", os.path.join(path, "__init__.py"))
module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(module)

# shadow module and register under legacy name
sys.modules["tigernix.upgrades"] = sys.modules["tigernix.addons.base.maintenance.migrations"] = module
