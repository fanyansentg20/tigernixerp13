...
class AccountMove(models.Model):
    ...
    def l10n_co_edi_download_electronic_invoice(self):
        ...
        if self.type == 'out_refund':
            ...
            tigernix_type_to_carvajal_type = {
                '1': 'FV',
                '2': 'FE',
                '3': 'FC',
            }
            carvajal_type = tigernix_type_to_carvajal_type[self.l10n_co_edi_type]
    ...
    def l10n_co_edi_check_status_electronic_invoice(self):
        ...
        for invoice in self.filtered('l10n_co_edi_transaction'):
            ...
            try:
                ...
                carvajal_status_to_tigernix = {
                    'PROCESSING': 'processing',
                    'OK': 'accepted',
                    'FAIL': 'rejected',
                }
                invoice.l10n_co_edi_invoice_status = carvajal_status_to_tigernix[response['status']]
