...
if hasattr(sys, 'frozen'):
    ...
    loader = jinja2.PackageLoader('tigernix.addons.hw_posbox_upgrade', "views")
...
class PosboxUpgrader(hw_proxy.Proxy):
    ...
    def upgrade(self):
        commit = subprocess.check_output(["git", "--work-tree=/home/pi/tigernix/", "--git-dir=/home/pi/tigernix/.git", "log", "-1"]).decode('utf-8').replace("\n", "<br/>")
        return upgrade_page_template.render({
            'title': "TigernixERP's IoTBox - Software Upgrade",
    ...
    def perform_upgrade(self):
        ...
        os.system('/home/pi/tigernix/addons/point_of_sale/tools/posbox/configuration/posbox_update.sh')
