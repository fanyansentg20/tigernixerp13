...
from tigernix.tests.common import TransactionCase, new_test_user
from tigernix.exceptions import ValidationError
from tigernix.service.model import check
...
class TestWebsiteResUsers(TransactionCase):
    ...
    def test_same_website_message(self):
        ...
        with self.assertRaises(ValidationError), mute_logger('tigernix.sql_db'):
