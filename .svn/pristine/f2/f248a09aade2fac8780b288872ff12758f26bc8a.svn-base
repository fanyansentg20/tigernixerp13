...
from tigernix import models, api, service
from tigernix.tools.translate import _
from tigernix.exceptions import UserError
from tigernix.tools import DEFAULT_SERVER_DATETIME_FORMAT, misc
...
class MercuryTransaction(models.Model):
    ...
    def _setup_request(self, data):
        ...
        data['memo'] = "TigernixERP " + service.common.exp_version()['server_version']
