...
from tigernix.fields import Datetime, Date
from tigernix.tests.common import tagged, TransactionCase
from tigernix.addons.hr_payroll.models.hr_work_entry import WorkIntervals
from tigernix.addons.hr_payroll.tests.common import TestPayslipBase
