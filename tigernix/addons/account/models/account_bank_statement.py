...
from tigernix.tools import float_compare, float_round, float_repr
...
class AccountBankStatementLine(models.Model):
    ...
    def _check_amount(self):
        for line in self:
            ...
            # so that user can enter/import the exact bank statement they have received from their bank in TigernixERP
