...
from tigernix import models, api, _, fields
from tigernix.osv import expression
from tigernix.release import version
from tigernix.tools import DEFAULT_SERVER_DATE_FORMAT as DF, safe_eval
from tigernix.tools.misc import formatLang, format_date as tigernix_format_date, get_lang
import random
        ...
        for journal in self:
            ...
            for activity in self.env.cr.dictfetchall():
                activities.append({
                    ...
                    'date': tigernix_format_date(self.env, activity.get('date_deadline'))
                })
