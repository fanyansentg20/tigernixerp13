...
from tigernix.exceptions import RedirectWarning, UserError, ValidationError
from tigernix.tools import float_is_zero, float_compare, safe_eval, date_utils, email_split, email_escape_char, email_re
from tigernix.tools.misc import formatLang, format_date, get_lang
...
class AccountMove(models.Model):
    ...
    def _get_invoice_reference_tigernixerp_invoice(self):
        """ This computes the reference based on the TigernixERP format.
    ...
    def _get_invoice_reference_tigernixerp_partner(self):
        """ This computes the reference based on the TigernixERP format.
