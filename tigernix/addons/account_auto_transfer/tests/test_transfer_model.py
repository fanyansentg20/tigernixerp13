...
from tigernix.addons.account_auto_transfer.tests.account_auto_transfer_test_classes import AccountAutoTransferTestCase

from tigernix import fields
from tigernix.models import ValidationError
...
class TransferModelTestCase(AccountAutoTransferTestCase):
    @patch('tigernix.addons.account_auto_transfer.models.transfer_model.TransferModel.action_perform_auto_transfer')
    ...
    @patch('tigernix.addons.account_auto_transfer.models.transfer_model.TransferModel._create_or_update_move_for_period')
    ...
    @patch('tigernix.addons.account_auto_transfer.models.transfer_model.TransferModel._get_auto_transfer_move_line_values')
    ...
    @patch('tigernix.addons.account_auto_transfer.models.transfer_model.TransferModel._get_non_analytic_transfer_values')
    @patch('tigernix.models.BaseModel.read_group')
    ...
    @patch(
        'tigernix.addons.account_auto_transfer.models.transfer_model.TransferModelLine._get_destination_account_transfer_move_line_values')
