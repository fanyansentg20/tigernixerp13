...
class TestAccountConsolidationJournal(AccountConsolidationTestCase):
    ...
    @patch(
        'tigernix.addons.account_consolidation.models.consolidation_period.ConsolidationPeriodComposition.get_journal_lines_values')
    @patch(
        'tigernix.addons.account_consolidation.models.consolidation_period.ConsolidationCompanyPeriod.get_journal_lines_values')
