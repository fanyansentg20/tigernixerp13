...
class TestConsolidationPeriod(AccountConsolidationTestCase):
    ...
    @patch(
        'tigernix.addons.account_consolidation.models.consolidation_period.ConsolidationPeriod._get_previous_similiar_period',
        return_value=False)
    @patch(
        'tigernix.addons.account_consolidation.models.consolidation_period.ConsolidationPeriod._get_company_periods_default_values_from_chart',
        return_value=[])
    ...
    @patch(
        'tigernix.addons.account_consolidation.models.consolidation_period.ConsolidationPeriod._get_previous_similiar_period')
    @patch(
        'tigernix.addons.account_consolidation.models.consolidation_period.ConsolidationPeriod._get_company_periods_default_values_from_period',
        return_value=[])
...
class TestConsolidationPeriodComposition(AccountConsolidationTestCase):
    ...
    @patch(
        'tigernix.addons.account_consolidation.models.consolidation_period.ConsolidationPeriod.action_generate_journals',
        return_value=False)
    ...
    @patch(
        'tigernix.addons.account_consolidation.models.consolidation_period.ConsolidationPeriodComposition._get_default_currency_rate',
        return_value=2.0)
    ...
    @patch('tigernix.addons.base.models.res_currency.Currency._get_conversion_rate', return_value=150.0)
...
class TestConsolidationCompanyPeriod(AccountConsolidationTestCase):
    ...
    @patch(
        'tigernix.addons.account_consolidation.models.consolidation_period.ConsolidationCompanyPeriod._get_total_balance_and_audit_lines',
        return_value=(42.0, []))
    @patch(
        'tigernix.addons.account_consolidation.models.consolidation_period.ConsolidationCompanyPeriod._apply_rates',
    ...
    @patch(
        'tigernix.addons.account_consolidation.models.consolidation_period.ConsolidationCompanyPeriod._convert')
    @patch(
        'tigernix.addons.account_consolidation.models.consolidation_period.ConsolidationCompanyPeriod._apply_consolidation_rate')
