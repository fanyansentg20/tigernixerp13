...
from tigernix.tools import float_is_zero
...
class ProviderAccount(models.Model):
    ...
    def log_message(self, message):
        ...
        # This call can also fail and if this is the case we do not want to prevent the user from deleting the object in tTigernixERP.
    ...
    def _get_favorite_institutions(self, country):
        resp_json = {}
        try:
            url = self.sudo().env['ir.config_parameter'].get_param('tigernix.online_sync_proxy') or 'https://onlinesync.tigernix.com'
