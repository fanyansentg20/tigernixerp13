...
from tigernix.addons.account.tests.account_test_classes import AccountingTestCase
...
class TestPlaidApi(AccountingTestCase):
    ...
    def setUp(self):
        ...
        self.url = 'https://onlinesync.tigernix.com/plaid/api/2'
    ...
    def plaid_post_error(self, *args, **kwargs):
        if (args[0].endswith('error_plaid')):
            ...
            return MockResponse(args[0], 'No valid TigernixERP Enterprise contract found for this database', {}, 403)
    ...
    def test_plaid_create_institution(self):
        ...
        # the account.online.provider with the linked accounts in TigernixERP
        
        # Patch request.post with defined method
        patcher = patch('tigernix.addons.account_plaid.models.plaid.requests.post', side_effect=self.plaid_post)
        patcher.start()
        metadata = {
    ...
    def test_plaid_fetch_errors(self):
        ...
        # Patch request.post with defined method
        patcher = patch('tigernix.addons.account_plaid.models.plaid.requests.post', side_effect=self.plaid_post_error)
        patcher.start()
        ...
        self.assertEqual(e.exception.name, 'No valid TigernixERP Enterprise contract found for this database')
