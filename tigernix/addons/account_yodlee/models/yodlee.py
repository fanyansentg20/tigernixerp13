...
from tigernix import models, api, fields, SUPERUSER_ID
from tigernix.exceptions import AccessError, UserError
...
class YodleeProviderAccount(models.Model):
    ...
    def _get_yodlee_credentials(self):
        ...
        base_url = self.sudo().env['ir.config_parameter'].get_param('tigernix.online_sync_proxy') or 'https://onlinesync.tigernix.com'
        url = base_url + '/yodlee/api/2'
        fastlink_url = 'https://usyirestmasternode.yodleeinteractive.com/authenticate/tigernixinc/?channelAppName=usyirestmaster'
    ...
    def get_error_from_code(self, code):
        return {
            ...
            '423': _("No Account Found (423): We were unable to detect an account. Please verify that you account information is available at this time and If the problem persists, please contact customer support at online@tigernix.com for further assistance."),
...
class YodleeAccount(models.Model):
    ...
    '''
    The yodlee account that is saved in TigernixERP.
