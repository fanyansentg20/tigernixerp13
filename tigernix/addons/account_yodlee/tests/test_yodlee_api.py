...
class TestYodleeApi(AccountingTestCase):
    ...
    def setUp(self):
        ...
        self.url = 'https://onlinesync.tigernix.com/yodlee/api/2'
    ...
    def test_yodlee_create_institution(self):
        ...
        patcher_post = patch('tigernix.addons.account_yodlee.models.yodlee.requests.post', side_effect=self.yodlee_post)
        patcher_get = patch('tigernix.addons.account_yodlee.models.yodlee.requests.get', side_effect=self.yodlee_get)
        patcher_post.start()
        patcher_get.start()
