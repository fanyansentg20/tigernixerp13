...
from tigernix import api, http, SUPERUSER_ID, _
from tigernix.exceptions import AccessDenied
from tigernix.http import request
from tigernix import registry as registry_get

from tigernix.addons.auth_signup.controllers.main import AuthSignupHome as Home
from tigernix.addons.web.controllers.main import db_monodb, ensure_db, set_cookie_and_redirect, login_and_redirect
...
class OAuthController(http.Controller):
    ...
    def oea(self, **kw):
        """login user via TigernixERP Account provider"""
        ...
        with registry.cursor() as cr:
            try:
                ...
                provider = env.ref('auth_oauth.provider_tigernixerp')
            except ValueError:
