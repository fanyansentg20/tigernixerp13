...
from tigernix.http import Controller, dispatch_rpc, request, route
from tigernix.service import wsgi_server
from tigernix.fields import Date, Datetime


class TigernixMarshaller(xmlrpc.client.Marshaller):
...
xmlrpc.client.Marshaller = TigernixMarshaller
