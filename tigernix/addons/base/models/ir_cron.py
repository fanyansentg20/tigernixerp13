...
BASE_VERSION = tigernix.modules.load_information_from_description_file('base')['version']
...
class ir_cron(models.Model):
    ...
    def _callback(self, cron_name, server_action_id, job_id):
        ...
        try:
            ...
            tigernix.netsvc.log(_logger, logging.DEBUG, 'cron.object.execute', (self._cr.dbname, self._uid, '*', cron_name, server_action_id), depth=log_depth)
            start_time = False
        ...
        try:
            ...
            for job in jobs:
                ...
                try:
                    ...
                    job_cr = db.cursor()
                    try:
                        registry = tigernix.registry(db_name)
    ...
    def _acquire_job(cls, db_name):
        ...
        try:
            ...
            if e.pgcode == '42P01':
                ...
                # The table ir_cron does not exist; this is probably not an TigernixERP database.
    ...
    def toggle(self, model, domain):
        # Prevent deactivated cron jobs from being re-enabled through side effects on neutralized databases.
