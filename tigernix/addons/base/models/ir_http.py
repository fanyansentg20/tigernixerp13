...
import tigernix
from tigernix import api, http, models, tools, SUPERUSER_ID
from tigernix.exceptions import AccessDenied, AccessError
from tigernix.http import request, content_disposition
from tigernix.tools import consteq, pycompat
from tigernix.tools.mimetypes import guess_mimetype
from tigernix.modules.module import get_resource_path, get_module_path

from tigernix.http import ALLOWED_DEBUG_MODES
from tigernix.tools.misc import str2bool
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls, key=None):
        ...
        if key not in cls._routing_map:
            ...
            installed = request.registry._init_modules | set(tigernix.conf.server_wide_modules)
            if tools.config['test_enable'] and tigernix.modules.module.current_test:
                installed.add(tigernix.modules.module.current_test)
