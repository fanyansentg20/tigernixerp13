...
class IrRule(models.Model):
    ...
    def write(self, vals):
        ...
        # DLE P33: tests
        # - tigernix/addons/test_access_rights/tests/test_feedback.py
        # - tigernix/addons/test_access_rights/tests/test_ir_rules.py
        # - tigernix/addons/base/tests/test_orm.py (/home/dle/src/tigernix/master-nochange-fp/tigernix/addons/base/tests/test_orm.py)
        self.flush()
        self.clear_caches()
        return res
