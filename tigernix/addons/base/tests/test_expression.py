...
class TestExpression(TransactionCase):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('tigernix.osv.expression'):
    ...
    def test_15_m2o(self):
        ...
        # that don't have TigernixERP has a parent company, you expect to find,
    ...
    def test_active(self):
        ...
        Partner = self.env['res.partner']
        vals = {
            'name': 'TigernixERP Test',
            'active': False,
            'category_id': [(6, 0, [self.ref("base.res_partner_category_0")])],
            'child_ids': [(0, 0, {'name': 'address of TigernixERP Test', 'country_id': self.ref("base.be")})],
        }
        Partner.create(vals)
