...
import tigernix
from tigernix.exceptions import UserError, ValidationError, AccessError
...
class TestCustomFields(common.TransactionCase):
    ...
    def test_create_unique(self):
        ...
        with self.assertRaises(IntegrityError), mute_logger('tigernix.sql_db'):
            self.create_field('x_foo')
    ...
    @mute_logger('tigernix.addons.base.models.ir_ui_view')
