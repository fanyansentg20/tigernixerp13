tigernix.define('bus.Longpolling', function (require) {
"use strict";
...
var LongpollingBus = Bus.extend(ServicesMixin, {
    ...
    /**
     * Tell whether TigernixERP is focused or not
     *
     * @returns {boolean}
     */
    isTigernixFocused: function () {
        return this._isTigernixFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isTigernixFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
            this.trigger('window_focus', this._isTigernixFocused);
        }
    },
    /**
