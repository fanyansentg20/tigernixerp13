tigernix.define('bus.BusService', function (require) {
"use strict";
...
var BusService =  CrossTab.extend(ServicesMixin, {
    ...
    _sendNativeNotification: function (title, content, callback) {
        var notification = new Notification(title, {body: content, icon: "/mail/static/src/img/tigernixbot_transparent.png"});
