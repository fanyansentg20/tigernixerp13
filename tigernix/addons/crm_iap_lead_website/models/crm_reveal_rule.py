...
from tigernix.addons.crm.models import crm_stage
from tigernix.exceptions import ValidationError

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://iap-services.tigernix.com'
...
class CRMRevealRule(models.Model):
    ...
    industry_tag_ids = fields.Many2many('crm.iap.lead.industry', string='Industries', help='Leave empty to always match. TigernixERP will not create lead if no match')
    ...
    def _assert_geoip(self):
        if not tigernix._geoip_resolver:
    ...
    # Methods responsible for format response data in to valid tigernix lead data
