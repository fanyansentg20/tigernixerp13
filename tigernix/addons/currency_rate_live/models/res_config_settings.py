...
from tigernix.addons.web.controllers.main import xml2json_from_elementtree
from tigernix.exceptions import UserError
from tigernix.tools.translate import _
from tigernix.tools import DEFAULT_SERVER_DATE_FORMAT
...
class ResCompany(models.Model):
    ...
    def _generate_currency_rates(self, parsed_data):
        ...
        exchange rate of their main currency equal to one in TigernixERP.
        """
