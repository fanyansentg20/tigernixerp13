...
class TestComputeRankCommon(common.TransactionCase):
    ...
    def setUp(self):
        ...
        patch_email = patch('tigernix.addons.mail.models.mail_template.MailTemplate.send_mail', _patched_send_mail)
        patch_email.start()
...
class test_recompute(TestComputeRankCommon):
    ...
    def test_02_update_rank_without_switch(self):
        ...
        patch_bulk = patch('tigernix.addons.gamification.models.res_users.Users._recompute_rank', _patched_recompute_rank)
        patch_bulk.start()
    ...
    def test_03_test_bulk_call(self):
        ...
        patch_bulk = patch('tigernix.addons.gamification.models.res_users.Users._recompute_rank_bulk', _patched_check_in_bulk)
        patch_bulk.start()
