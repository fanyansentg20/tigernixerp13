...
from tigernix.exceptions import AccessError, ValidationError, UserError
from tigernix.tools import mute_logger, test_reports

from tigernix.addons.hr_holidays.tests.common import TestHrHolidaysBase
...
class TestHolidaysFlow(TestHrHolidaysBase):
    ...
    def test_sql_constraint_dates(self):
        ...
        with mute_logger('tigernix.sql_db'):
