tigernix.define('im_support.systray.MessagingMenu', function (require) {
"use strict";
...
MessagingMenu.include({
    ...
    init: function () {
        ...
        this.supportChannel = {
            ...
            name: _t("TigernixERP Live Support"),
            title: _t("TigernixERP Live Support"),
            imageSRC: '/mail/static/src/img/tigernix_o.png',
        };
    },
    /**
