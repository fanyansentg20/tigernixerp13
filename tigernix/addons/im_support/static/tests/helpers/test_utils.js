tigernix.define('im_support.test_utils', function (require) {
"use strict";
...
function addMockSupportEnvironment(widget, params) {
    ...
    var defaultMockSupportRPC = function (route, args) {
        ...
        if (route === '/tigernix_im_support/fetch_messages') { // fetching history
            return Promise.resolve([]);
        }
        if (route === '/tigernix_im_support/chat_post') {
            return Promise.resolve();
        }
