...
from tigernix import tools, models, fields, api, _
...
class AccountArVatLine(models.Model):
    ...
    changes in tigernix, this ones will be taken for this cube and then no changes will be nedeed in the reports that use
    ...
    def init(self):
        ...
        # * we use same method as in tigernix tax report to avoid any possible discrepancy with the computed tax_base_amount
        query = """
SELECT
    am.id,
