...
from tigernix.exceptions import Warning
from tigernix.tools import float_is_zero, pycompat
...
class AccountFrFec(models.TransientModel):
    ...
    def generate_fec(self):
        ...
        # but TigernixERP has the label on the account.move.line, so that's a
        # problem !
