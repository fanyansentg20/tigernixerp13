...
from tigernix.addons.base.models.ir_mail_server import MailDeliveryException
        ...
        for server_id, batch_ids in self._split_by_server():
            ...
            try:
                ...
                if raise_exception:
                    ...
                    # exceptions, it is encapsulated into an TigernixERP MailDeliveryException
        ...
        for mail_id in self.ids:
            ...
            try:
                ...
                if res:  # mail has been sent at least once, no major exception occured
                    ...
                    # see revid:odo@TigernixERP.com-20120622152536-42b2s28lvdv3odyr in 6.1
