tigernix.define('mail.model.Message', function (require) {
"use strict";
...
var Message =  AbstractMessage.extend(Mixins.EventDispatcherMixin, ServicesMixin, {
    ...
    getAvatarSource: function () {
        if (this._isTigernixbotAuthor()) {
            return '/mail/static/src/img/tigernixbot.png';
     ...
     *
     * Do not redirect on author clicked of self-posted or TigernixERPbot messages
     * (note: TigernixERPbot is the default author of transient messages)
     *
     * @override
     * @return {boolean}
     */
    shouldRedirectToAuthor: function () {
        return this._super.apply(this, arguments) && !this._isTigernixbotAuthor();
    },
    /**
    ...
    /**
     * Get the name of the author of this message.
     * If TigernixERPbot is the author (default author for transient messages),
     * returns 'Tigernixbot'.
     *
     * @override
     * @private
    ...
    /**
     * State if the author of this message is TigernixERPBot
     * This is the default author for transient messages.
     *
     * @private
     * @return {boolean}
     */
    _isTigernixbotAuthor: function () {
        return this._serverAuthorID &&
            this._serverAuthorID[0] === this.call('mail_service', 'getTigernixbotID')[0];
    },
    /**
