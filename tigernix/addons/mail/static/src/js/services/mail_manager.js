tigernix.define('mail.Manager', function (require) {
"use strict";
...
var MailManager =  AbstractService.extend({
    ...
    _isReady: false,
    _TIGERNIXBOT_ID: ["TIGERNIXBOT", "TIGERNIXBOT"], // authorID for transient messages
    ...
    /**
     * Get the TigernixERPBot ID, which is the default authorID for transient messages
     *
     * @returns {Array<string>}
     */
    getTigernixbotID: function () {
        return this._TIGERNIXBOT_ID;
    },
    /**
                ...
                if (
                    ...
                    if (thread.isTwoUserThread() && options.showNotification) {
                        ...
                        prom.then(function () {
                            ...
                            if (!self.call('bus_service', 'isTigernixFocused') || !query.isVisible) {
    ...
    _initializeInternalState: function () {
        ...
        // # of message received when TigernixERP is out of focus
    ...
    _notifyIncomingMessage: function (message) {
        if (this.call('bus_service', 'isTigernixFocused')) {
            // no need to notify
            return;
        }
