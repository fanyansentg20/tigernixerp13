tigernix.define('mail_bot.systray.MessagingMenu', function (require) {
"use strict";
...
return MessagingMenu.include({
     ...
     * messaging menu (e.g. 'TigernixERPBot has a request')
     *
     * @override
     * @private
     ...
     * TigernixERPBot, and the TigernixERPBot influences the counter by 1 when it requests
    ...
    _handleResponseNotificationPermission: function (value) {
        ...
        if (value !== 'granted') {
            this.call('bus_service', 'sendNotification', _t('Permission denied'),
                _t('TigernixERP will not have the permission to send native notifications on this device.'));
        }
        this._updateCounter();
    },
    /**
    ...
    /**
     * Override so that it handles preview related to TigernixERPBot
     *
     * @override
     * @private
     * @param {MouseEvent} ev
