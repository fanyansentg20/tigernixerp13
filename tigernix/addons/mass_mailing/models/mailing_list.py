...
class MassMailingList(models.Model):
    ...
    def action_merge(self, src_lists, archive):
        ...
        # A (id=4): yti@tigernix.com; yti@example.com
        # B (id=5): yti@tigernix.com; yti@tigernixERP.com
        # C (id=6): nothing
        ...
        # ------------+---------------------------+------------------------
        #           4 | yti@tigernix.com          |          1 |        4 |
        #           6 | yti@tigernix.com          |          2 |        5 |
        #           5 | yti@example.com           |          1 |        4 |
        #           7 | yti@tigernixERP.com       |          1 |        5 |
        #
