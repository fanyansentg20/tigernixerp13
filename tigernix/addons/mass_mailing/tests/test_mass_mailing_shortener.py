...
class TestMassMailingShortener(common.TransactionCase):
    ...
    def setUp(self):
        ...
        patcher = patch('tigernix.addons.link_tracker.models.link_tracker.LinkTracker._compute_favicon', wraps=_compute_favicon)
        patcher2 = patch('tigernix.addons.link_tracker.models.link_tracker.LinkTracker._get_title_from_url', wraps=_get_title_from_url)
        patcher.start()
        patcher2.start()
    ...
    def test_00_test_mass_mailing_shortener(self):
        ...
        mass_mailing = self.env['mailing.mailing'].create({
            ...
            "body_html": """
Hi,
% set url = "www.tigernix.com"
% set httpurl = "https://www.tigernix.eu"
Website0: <a id="url0" href="https://www.tigernix.tz/my/${object.name}">https://www.tigernix.tz/my/${object.name}</h1>
Website1: <a id="url1" href="https://www.tigernix.be">https://www.tigernix.be</h1>
Website2: <a id="url2" href="https://${url}">https://${url}</h1>
Website3: <a id="url3" href="${httpurl}">${httpurl}</h1>
Email: <a id="url4" href="mailto:test@tigernix.com">test@tigernix.com</h1>
            """,
            "schedule_date": False,
            "state": "draft",
            "keep_archives": True,
        ...
        self.assertEqual(after_url4, "mailto:test@tigernix.com", 'mailto: has been converted')
        ...
        self.assertTrue("https://www.tigernix.tz/my/User" in short0.url, 'URL mismatch')
        self.assertEqual(short1.url, "https://www.tigernix.be", 'URL mismatch')
        self.assertEqual(short2.url, "https://www.tigernix.com", 'URL mismatch')
        self.assertEqual(short3.url, "https://www.tigernix.eu", 'URL mismatch')
        ...
        self.assertEqual(_after_url4, "mailto:test@tigernix.com", 'mailto: has been converted')
        ...
        self.assertTrue("https://www.tigernix.tz/my/User" in _short0.url, 'URL mismatch')
        self.assertEqual(_short1.url, "https://www.tigernix.be", 'URL mismatch')
        self.assertEqual(_short2.url, "https://www.tigernix.com", 'URL mismatch')
        self.assertEqual(_short3.url, "https://www.tigernix.eu", 'URL mismatch')
