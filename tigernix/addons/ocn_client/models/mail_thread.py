...
from tigernix import _, models, api
...
class MailThread(models.AbstractModel):
    ...
    def _notify_compute_recipients(self, message, msg_vals):
        ...
        if not self.env['ir.config_parameter'].sudo().get_param('tigernix_ocn.project_id'):
            return rdata
        ...
        if msg_type == 'comment':
            ...
            # doesn't want to handle notifications in TigernixERP.
