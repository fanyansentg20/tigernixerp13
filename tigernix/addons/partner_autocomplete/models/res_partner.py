...
import logging
import json
from tigernix import api, fields, models, exceptions, _
from tigernix.addons.iap import jsonrpc
from requests.exceptions import ConnectionError, HTTPError
from tigernix.addons.iap.models.iap import InsufficientCreditError

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://partner-autocomplete.tigernix.com'
