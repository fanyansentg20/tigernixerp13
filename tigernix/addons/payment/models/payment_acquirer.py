...
from tigernix import api, exceptions, fields, models, _, SUPERUSER_ID
from tigernix.tools import consteq, float_round, image_process, ustr
from tigernix.addons.base.models import ir_module
from tigernix.exceptions import ValidationError
from tigernix.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
from tigernix.tools.misc import formatLang
...
class PaymentAcquirer(models.Model):
    ...
    TigernixERP and the acquirer. It generally consists in return urls given to the
    ...
    capture_manually = fields.Boolean(string="Capture Amount Manually",
        help="Capture the amount from TigernixERP, when the delivery is completed.")
    ...
    module_to_buy = fields.Boolean(string='TigernixERP Enterprise Module', related='module_id.to_buy', readonly=True, store=False)

    image_128 = fields.Image("Image", max_width=128, max_height=128)

    payment_icon_ids = fields.Many2many('payment.icon', string='Supported Payment Icons')
    payment_flow = fields.Selection(selection=[('form', 'Redirection to the acquirer website'),
        ('s2s','Payment from TigernixERP')],
