...
# -*- coding: utf-8 -*-
# Part of TigernixERP. See LICENSE file for full copyright and licens

from tigernix import http, fields, _
...
class ShiftController(http.Controller):
    ...
    def _format_planning_shifts(color_code):
        """Take a color code from TigernixERP's Kanban view and returns an hex code compatible with the fullcalendar library"""
