tigernix.define('point_of_sale.models', function (require) {
"use strict";
...
exports.PosModel = Backbone.Model.extend({
    ...
    models: [
    {
        ...
        loaded: function(self, pos_sessions, tmp){
            ...
            self.pos_session.login_number = tigernix.login_number;
...
// Loads TigernixERP models at the point of sale startup.
// load_models take an array of model loader declarations.
// - The models will be loaded in the array order.
// - If no TigernixERP model name is provided, no server data
...
//
// models: [{
//  model: [string] the name of the TigernixERP model to load.
...
//  context: [Dict|function] the tigernixerp context for the model read
