tigernix.define('pos_adyen.payment', function (require) {
"use strict";
...
var PaymentAdyen = PaymentInterface.extend({
    ...
    _handle_tigernix_connection_failure: function (data) {
        // handle timeout
        var line = this.pos.get_order().selected_paymentline;
        if (line) {
            line.set_payment_status('retry');
        }
        this._show_error(_('Could not connect to the TigernixERP server, please check your internet connection and try again.'));
    ...
    _call_adyen: function (data) {
        ...
        return rpc.query({
            ...
            // before concluding TigernixERP is unreachable.
            timeout: 10000,
            shadow: true,
        }).catch(this._handle_tigernix_connection_failure.bind(this));
    },
    ...
    _poll_for_response: function (resolve, reject) {
        ...
        return rpc.query({
            ...
            reject();
            return self._handle_tigernix_connection_failure(data);
