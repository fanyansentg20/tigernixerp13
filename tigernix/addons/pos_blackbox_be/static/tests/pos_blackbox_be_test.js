tigernix.define_section('pos_blackbox_be.Order', ['point_of_sale.models'], function (test, mock) {
    function mock_pos() {
        var pos = {
            'pos_session': {
                'id': 1
...
tigernix.define_section('pos_blackbox_be.FDMPacket', ['pos_blackbox_be.pos_blackbox_be'], function (test, mock) {
