...
from tigernix.tests import TransactionCase
...
BASE_ITEM_DATA = {
    ...
    'Title': {'value': 'TigernixBike Spare Wheel, 26x2.1, Pink, 200-Pack'},
...
class TestAmazon(TransactionCase):
    ...
    def setUp(self):
        ...
        with patch('tigernix.addons.sale_amazon.models.mws_connector.get_api_connector',
                   new=lambda *args, **kwargs: None), \
             patch('tigernix.addons.sale_amazon.models.mws_connector.get_available_marketplace_api_refs',
    ...
    def test_update_marketplaces_no_change(self):
        ...
        with patch(
                'tigernix.addons.sale_amazon.models.amazon_account.AmazonAccount'
    ...
    @mute_logger('tigernix.addons.sale_amazon.models.amazon_account')
    def test_sync_orders_full(self):
        ...
        with patch('tigernix.addons.sale_amazon.models.mws_connector.get_api_connector',
                   new=lambda *args, **kwargs: None), \
             patch('tigernix.addons.sale_amazon.models.mws_connector.get_orders_data',
                   new=_get_orders_data_mock), \
             patch('tigernix.addons.sale_amazon.models.mws_connector.get_items_data',
                   new=_get_items_data_mock), \
             patch('tigernix.addons.sale_amazon.models.amazon_account.AmazonAccount._get_product',
    ...
    @mute_logger('tigernix.addons.sale_amazon.models.amazon_account')
    @mute_logger('tigernix.addons.sale_amazon.models.sale')
    def test_sync_cancellations(self):
        ...
        with patch('tigernix.addons.sale_amazon.models.mws_connector.get_api_connector',
             ...
             patch('tigernix.addons.sale_amazon.models.mws_connector.get_items_data',
                   new=_get_items_data_mock), \
             patch('tigernix.addons.sale_amazon.models.mws_connector.submit_feed',
    ...
    @mute_logger('tigernix.addons.sale_amazon.models.amazon_account')
    @mute_logger('tigernix.addons.sale_amazon.models.stock_picking')
    ...
    def test_get_partners_creation_contact(self):
        ...
        self.assertEqual(contact.city, 'TigernixCity')
