...
from tigernix.addons.sale_subscription.tests.common_sale_subscription import TestSubscriptionCommon
from tigernix.tests import Form
...
class TestSubscription(TestSubscriptionCommon):
    ...
    @mute_logger('tigernix.addons.base.models.ir_model', 'tigernix.models')
    ...
    def test_04_auto_payment_with_token(self):
        ...
        patchers = [
            patch('tigernix.addons.sale_subscription.models.sale_subscription.SaleSubscription._prepare_invoice_line', wraps=self._mock_prepare_invoice_line, create=True),
            patch('tigernix.addons.sale_subscription.models.sale_subscription.SaleSubscription._prepare_invoice_data', wraps=self._mock_prepare_invoice_data, create=True),
            patch('tigernix.addons.sale_subscription.models.sale_subscription.SaleSubscription._do_payment', wraps=self._mock_subscription_do_payment, create=True),
            patch('tigernix.addons.sale_subscription.models.sale_subscription.SaleSubscription.send_success_mail', wraps=self._mock_subscription_send_success_mail, create=True),
        ]
    ...
    @mute_logger('tigernix.models.unlink')
    ...
    @mute_logger('tigernix.addons.mail.models.mail_mail', 'tigernix.models.unlink')
