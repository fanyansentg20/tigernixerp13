tigernix.define('sale_subscription_dashboard.sale_subscription_tests', function (require) {
    "use strict";
        ...
        beforeEach: function () {
            this.data = {
                fetch_data: {
                    ...
                    contract_templates: [{
                        id: 1,
                        name: "TigernixERP Monthly"
                    }, {
                        id: 2,
                        name: "TigernixERP Yearly"
                    }],
                    tags: [{
                        id: 1,
                        name: "Contracts"
                ...
                salesman_values: {
                    ...
                    contract_modifications: [{
                        ...
                        account_analytic_template: "TigernixERP Monthly",
                        previous_mrr: 500,
                        current_mrr: 800,
                        diff: 300,
                        type: 'up',
