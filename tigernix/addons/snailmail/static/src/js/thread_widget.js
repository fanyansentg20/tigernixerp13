tigernix.define('snailmail.widget.Thread', function (require) {
"use strict";
...
ThreadWidget.include({
    ...
    _onClickUnknownError: function (ev) {
        var messageID = $(ev.currentTarget).data('message-id');
        var content = _t('<p>An unknown error occured. Please contact our <a href="https://www.tigernix.com/help" target="new">support</a> for further assistance.</p>');
        this._openGenericErrorDialog(messageID, content);
    },
});
