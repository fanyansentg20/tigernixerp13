...
class SocialLivePostPushNotifications(models.Model):
    ...
    def _post_push_notifications(self):
        for live_post in self:
            ...
            icon_url = '/web/image/social.post/%s/push_notification_image/64x64' % post.id if post.push_notification_image else '/mail/static/src/img/tigernixbot_transparent.png'
