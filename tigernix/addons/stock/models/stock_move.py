...
from tigernix import api, fields, models, _, SUPERUSER_ID
from tigernix.exceptions import UserError
from tigernix.osv import expression
from tigernix.tools.float_utils import float_compare, float_round, float_is_zero
        ...
        if self.product_qty < self._origin.product_qty:
            warning_mess = {
                ...
                'message' : _("By changing this quantity here, you accept the "
                              "new quantity as complete: TigernixERP will not "
