tigernix.define('stock_barcode.ClientAction', function (require) {
'use strict';
...
var ClientAction = AbstractAction.extend({
    ...
    *
    ...
    /**
     * Handles the `exit` TigernixERPEvent. We disable the fullscreen mode and trigger_up an
     * `history_back`.
     *
     * @private
     * @param {TigernixEvent} ev
     */
     _onExit: function (ev) {
        ev.stopPropagation();
        var self = this;
    ...
    /**
     * Handles the `add_product` TigernixERPEvent. It destroys `this.linesWidget` and displays an instance
    ...
    /**
     * Handles the `edit_product` TigernixERPEvent. It destroys `this.linesWidget` and displays an instance
     * of `ViewsWidget` for the line model.
     *
    ...
    /**
     * Handles the `show_information` TigernixERPEvent. It hides the main widget and
    ...
    /**
     * Handles the `show_settings` TigernixERPEvent. It hides `this.linesWidget` and dipslays
     * `this.settinsWidget`.
     *
     * @private
     * @param {TigernixEvent} ev
    ...
    /**
     * Handles the `reload` TigernixERPEvent.
     * Currently, this event is only triggered by `this.ViewsWidget`.
     *
     * @private
     * @param {TigernixEvent} ev ev.data could contain res_id
     */
    ...
    /**
     * Handles the `next_move` TigernixERPEvent. It makes `this.linesWidget` display
    ...
    /**
     * Handles the `previous_move` TigernixERPEvent. It makes `this.linesWidget` display
    ...
    /**
     * Handles the 'main_menu' TigernixERPEvent. It's used when we want to go back the
     * main app menu.
     * @private
     */
    ...
    /**
     * Handles the 'listen_to_barcode_scanned' TigernixERPEvent.
     *
     * @private
     * @param {TigernixEvent} ev ev.data.listen
     */
