tigernix.define('stock_barcode.picking_client_action', function (require) {
'use strict';
...
var PickingClientAction = ClientAction.extend({
    ...
    /**
     * Handles the `open_package` TigernixERPEvent. It hides the main widget and
    ...
    /**
     * Handles the `validate` TigernixERPEvent. It makes an RPC call
    ...
    /**
     * Handles the `cancel` TigernixERPEvent. It makes an RPC call
    ...
    /**
     * Handles the `print_picking` TigernixERPEvent. It makes an RPC call
    ...
    /**
     * Handles the `print_delivery_slip` TigernixERPEvent. It makes an RPC call
    ...
    /**
     * Handles the `print_barcodes_zpl` TigernixERPEvent. It makes an RPC call
    ...
    /**
     * Handles the `print_barcodes_pdf` TigernixERPEvent. It makes an RPC call
     * to the method 'do_print_barcodes_zpl'.
     *
     * @private
     * @param {TigernixEvent} ev
    ...
    /**
     * Handles the `scan` TigernixERPEvent. It makes an RPC call
    ...
    /**
     * Handles the `Put in pack` TigernixERPEvent. It makes an RPC call
