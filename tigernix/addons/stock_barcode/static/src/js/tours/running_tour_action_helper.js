tigernix.define('stock_barcode.RunningTourActionHelper', function(require) {
"use strict";
...
RunningTourActionHelper.include({
    _scan: function (element, barcode) {
        tigernix.__DEBUG__.services['web.core'].bus.trigger('barcode_scanned', barcode, element);
    },
