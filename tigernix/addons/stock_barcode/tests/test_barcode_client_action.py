...
import tigernix
from tigernix.tests import HttpCase, tagged
...
class TestPickingBarcodeClientAction(TestBarcodeClientAction):
    def test_internal_picking_from_scratch_1(self):
        ...
        picking_write_orig = tigernix.addons.stock.models.stock_picking.Picking.write
        ...
        with patch('tigernix.addons.stock.models.stock_picking.Picking.write', new=picking_write_mock):
