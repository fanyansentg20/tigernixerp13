...
from tigernix.tools import formataddr
...
class TestTracking(common.BaseFunctionalTest, common.MockEmails):
    ...
    def test_create_partner_from_tracking_multicompany(self):
        ...
        with patch('tigernix.addons.mail.models.mail_thread.MailThread._message_track_post_template', patched_message_track_post_template):
