...
from tigernix.addons.base.models.ir_mail_server import IrMailServer
from tigernix.fields import Datetime
from tigernix.tools import mute_logger

from tigernix.addons.test_marketing_automation.tests.common import MarketingCampaignTestBase
...
for record in records:
    ...
    @mute_logger('tigernix.addons.base.ir.ir_model', 'tigernix.models')
