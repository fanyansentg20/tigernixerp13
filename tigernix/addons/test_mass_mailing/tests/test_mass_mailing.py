...
from tigernix.addons.test_mass_mailing.tests.common import MassMailingCase
from tigernix.addons.base.models.ir_config_parameter import IrConfigParameter
from tigernix.tests.common import TransactionCase, users
