...
from tigernix.tools import mute_logger, float_repr
from tigernix.tools.date_utils import add, subtract, start_of, end_of
...
class TestFields(common.TransactionCase):
    ...
    def test_90_binary_svg(self):
        from tigernix.addons.base.tests.test_mimetypes import SVG
...
class TestX2many(common.TransactionCase):
    ...
    def test_10_ondelete_many2many(self):
        ...
        with self.assertRaises(psycopg2.IntegrityError):
            with mute_logger('tigernix.sql_db'), self.cr.savepoint():
                record_a.unlink()
