...
class IrTranslation(models.Model):
    ...
    def _get_transifex_url(self):
        ...
        if not base_url or not tx_sections:
            ...
            # using ini files like '[tigernix-master.website_sale]'
            ...
            for translation in self:
                ...
                # e.g. https://www.transifex.com/tigernix/tigernix-10/translate/#fr/sale/42?q=text'Sale+Order'
