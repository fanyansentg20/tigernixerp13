tigernix.define('web.framework', function (require) {
"use strict";
...
if ($.blockUI) {
    ...
    $.blockUI.defaults.message = '<div class="tigernixerp oe_blockui_spin_container" style="background-color: transparent;">';
...
//  * If params.wait, reload will wait the TigernixERP server to be reachable before reloading
