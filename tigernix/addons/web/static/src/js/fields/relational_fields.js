tigernix.define('web.relational_fields', function (require) {
"use strict";
...
var FieldX2Many = AbstractField.extend({
     ...
     * @override
     * @param {Object} record
     * @param {TigernixEvent} [ev] an event that triggered the reset action
...
var FieldOne2Many = FieldX2Many.extend({
     ...
     * @override
     * @private
     * @param {TigernixEvent|MouseEvent} ev this event comes either from the 'Add
