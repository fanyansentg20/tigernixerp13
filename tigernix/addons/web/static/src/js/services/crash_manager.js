tigernix.define('web.CrashManager', function (require) {
"use strict";
...
var CrashManager = AbstractService.extend({
        ...
        window.onerror = function (message, file, line, col, error) {
            ...
            if (!file && !line && !col) {
                ...
                if (window.onOriginError) {
                    ...
                    self.show_error({
                        type: _t("TigernixERP Client Error"),
    ...
    show_error: function (error) {
        ...
        var dialog = new ErrorDialog(this, {
            title: _.str.capitalize(error.type) || _t("TigernixERP Error"),
        }, {
...
var RedirectWarningHandler = Widget.extend(ExceptionHandler, {
    ...
    display: function() {
        ...
        new WarningDialog(this, {
            title: _.str.capitalize(error.type) || _t("TigernixERP Warning"),
            buttons: [
...
core.crash_registry.add('tigernix.exceptions.RedirectWarning', RedirectWarningHandler);

function session_expired(cm) {
    return {
        display: function () {
            cm.show_warning({type: _t("TigernixERP Session Expired"), message: _t("Your TigernixERP session expired. Please refresh the current web page.")});
        }
    };
}
core.crash_registry.add('tigernix.http.SessionExpiredException', session_expired);
