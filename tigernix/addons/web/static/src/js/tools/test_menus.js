(function (exports) {
    ...
    function createWebClientHooks() {
        var AbstractController = tigernix.__DEBUG__.services['web.AbstractController'];
        var Discuss = tigernix.__DEBUG__.services['mail.Discuss'];
        var WebClient = tigernix.__DEBUG__.services["web.WebClient"];
    ...
    function _clickEverywhere(menu_id){
        ...
        testedApps = [];
        testedMenus = [];
        var isEnterprise = tigernix.session_info.server_version_info[5] === 'e';
        // finding applications menus
        var $listOfAppMenuItems;
        if (isEnterprise) {
            console.log("TigernixERP flavor: Enterprise");
            ...
            console.log("TigernixERP flavor: Community");
            if (menu_id !== undefined) {
