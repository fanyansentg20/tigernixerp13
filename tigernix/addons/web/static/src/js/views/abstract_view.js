tigernix.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. TigernixERP JS views are the
 ...
 * the word 'view' has historical significance in TigernixERP code, so we replaced the
