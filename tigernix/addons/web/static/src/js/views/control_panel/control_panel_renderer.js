tigernix.define('web.ControlPanelRenderer', function (require) {
"use strict";
...
var ControlPanelRenderer = Renderer.extend({
    ...
    _setSearchMenusVisibility: function () {
        this.$('.o_searchview_more')
            .toggleClass('icon-search-list', !this.displaySearchMenu)
            .toggleClass('icon-search-unlist', this.displaySearchMenu);
