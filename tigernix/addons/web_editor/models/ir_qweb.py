...
Also, adds methods to convert values back to TigernixERP models.
"""
...
from tigernix import api, models, fields
from tigernix.tools import ustr, pycompat
from tigernix.tools import html_escape as escape
from tigernix.addons.base.models import ir_qweb
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = tigernix.modules.get_module_resource(
