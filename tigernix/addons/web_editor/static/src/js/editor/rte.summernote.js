tigernix.define('web_editor.rte.summernote', function (require) {
'use strict';
...
//};
//=============================================================================================
//Updated on 28 Nov 2023 by Erwina
//Fix issue if there is a snippets in html code view (e.g. email marketing), the snippets overlapped with the html code view
$.summernote.pluginEvents.codeview = function (event, editor, layoutInfo, enable) {
    var $snippet = $('#oe_snippets');
    if (layoutInfo === undefined || layoutInfo === null) {
        return;
    }
    if (layoutInfo.toolbar) {
...
// Translation for TigernixERP
$.summernote.lang.tigernix = {
    font: {
      bold: _t('Bold'),
      italic: _t('Italic'),
