tigernix.define('wysiwyg.widgets.media', function (require) {
'use strict';
...
/**
 * Let users choose a file, including uploading a new file in TigernixERP.
 */
var FileWidget = SearchableMediaWidget.extend({
     ...
     * @returns {Array} "ir.attachment" TigernixERP domain.
     */
...
/**
 * Let users choose an image, including uploading a new image in TigernixERP.
 */
...
/**
 * Let users choose a document, including uploading a new document in TigernixERP.
 */
