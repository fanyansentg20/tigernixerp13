tigernix.define('web_enterprise.HomeMenu', function (require) {
"use strict";
...
tigernix.define('web_enterprise.ExpirationPanel', function (require) {
"use strict";
...
HomeMenu.include({
    ...
    _enterpriseExpirationCheck: function () {
        ...
        var expiration_date = "2099-01-01 00:00:00"
        var dbexpirationDate = new moment(expiration_date || new moment().add(30, 'd'));
