tigernix.define('web_mobile.rpc', function () {
"use strict";

var available = typeof TigernixDeviceUtility !== 'undefined';
var DeviceUtility;
var deferreds = {};
var methods = {};

if (available){
    DeviceUtility = TigernixDeviceUtility;
    delete window.TigernixDeviceUtility;
}
 ...
 * @param {Object} result
 */
window.tigernix.native_notify = function (id, result) {
