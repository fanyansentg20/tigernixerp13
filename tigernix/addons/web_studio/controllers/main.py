...
from tigernix.http import content_disposition, request
from tigernix.exceptions import UserError, AccessError, ValidationError
from tigernix.addons.web_studio.controllers import export
from tigernix.tools import ustr, sql
...
class WebStudioController(http.Controller):
    ...
    def _generate_studio_view_name(self, view):
        return "TigernixERP Studio: %s customization" % (view.name)
