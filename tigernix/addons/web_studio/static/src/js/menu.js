tigernix.define('web_studio.Menu', function (require) {
"use strict";
...
Menu.include({
    ...
    switchMode: function (mode) {
        ...
        if (mode) {
            ...
            this.$notes = $('<div>')
                ...
                .append($('<a>', {
                    href: 'http://pad.tigernix.com/p/customization-' + session.dbuuid,
                    target: '_blank',
                    text: _t("Notes"),
                }));
    ...
    /**
     * Export all customizations done by Studio in a zip file containing TigernixERP
     * modules.
     *
     * @param {Event} event
     */
