import random
import textwrap
from tigernix.http import _request_stack
from tigernix.tests.common import TransactionCase
from tigernix.tools import DotDict
from tigernix.addons.web_studio.controllers.main import WebStudioController
                ...
                <sheet>
                    ...
                    <group>
                        <group>
                            ...
                            <field name="website" widget="url" placeholder="e.g. www.tigernix.com"/>
                        </group>
                        <group>
