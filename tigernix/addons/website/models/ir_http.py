...
from tigernix.osv.expression import FALSE_DOMAIN, OR

from tigernix.addons.http_routing.models.ir_http import ModelConverter, _guess_mimetype
from tigernix.addons.portal.controllers.portal import _build_url_w_params
...
class Http(models.AbstractModel):
    ...
    def _dispatch(cls):
        """
        In case of rerouting for translate (e.g. when visiting tigernix.com/fr_BE/),
