tigernix.define('website.root', function (require) {
'use strict';
...
var WebsiteRoot = publicRootData.PublicRoot.extend({
    ...
    start: function () {
        ...
        this.$('.zoomable img[data-zoom]').zoomTigernix();
            ...
            return new Dialog(self, {
                ...
                $content: $('<div/>', {
                    html: (data.data ? data.data.arguments[1] : data.statusText)
                        + '<br/>'
                        + _.str.sprintf(
                            _t('It might be possible to edit the relevant items or fix the issue in <a href="%s">the classic TigernixERP interface</a>'),
