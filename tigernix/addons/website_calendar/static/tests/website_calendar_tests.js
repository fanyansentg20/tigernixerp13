tigernix.define('website_calendar.tests', function (require) {
"use strict";
...
QUnit.module('website_calendar', {
    ...
    QUnit.test("empty previous_order widget", async function (assert) {
        ...
        var form = await createView({
            ...
            res_id: 1,
            session: {
                'web.base.url': 'http://amazing.tigernix.com',
            },
            model: 'calendar.appointment.type',
        });

        assert.hasAttrValue(form.$('.o_form_uri'), 'href',
            'http://amazing.tigernix.com/website/calendar/schedule-a-demo-1?employee_id=214',
    ...
    QUnit.test("new record appointment_employee_url widget", async function (assert) {
        ...
        form.$('.o_form_uri').each(function (i,r) {
            var link = "";
            if (i === 1) {
                link = "http://amazing.tigernix.com/aaa/aaa/?employee_id=216"
            } else {
                link = "http://amazing.tigernix.com/aaa/aaa/?employee_id=214"
            }
