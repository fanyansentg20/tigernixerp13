function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('tigernix-google-map'), {
        zoom: 1,
    ...
    if (tigernix_partner_data){ /* TigernixERP_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < tigernix_partner_data.counter; i++) {
            set_marker(tigernix_partner_data.partners[i]);
        }
