tigernix.define('website_sale.cart', function (require) {
'use strict';
...
tigernix.define('website_sale.website_sale_category', function (require) {
'use strict';
...
tigernix.define('website_sale.website_sale', function (require) {
'use strict';
        ...
        if (!config.device.isMobile) {
            ...
            _.each($('.ecom-zoomable img[data-zoom]'), function (el) {
                onImageLoaded(el, function () {
                    var $img = $(el);
                    $img.zoomTigernix({event: autoZoom ? 'mouseenter' : 'click', attach: attach});
