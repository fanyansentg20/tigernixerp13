...
class TestUi(tests.HttpCase):
    ...
    def test_course_member_employee(self):
        ...
        self.phantom_js(
            '/slides',
            'tigernix.__DEBUG__.services["web_tour.tour"].run("course_member")',
            'tigernix.__DEBUG__.services["web_tour.tour"].tours.course_member.ready',
...
class TestUiYoutube(tests.HttpCase):
    ...
    def test_course_member_yt_employee(self):
        ...
        self.phantom_js(
            '/slides',
            'tigernix.__DEBUG__.services["web_tour.tour"].run("course_member_youtube")',
            'tigernix.__DEBUG__.services["web_tour.tour"].tours.course_member_youtube.ready',
            login=user_demo.login)
    ...
    def test_course_publisher_website_designer(self):
        ...
        self.phantom_js(
            '/slides',
            'tigernix.__DEBUG__.services["web_tour.tour"].run("course_publisher")',
            'tigernix.__DEBUG__.services["web_tour.tour"].tours.course_publisher.ready',
            login=user_demo.login)
