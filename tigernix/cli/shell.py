        ...
        with tigernix.api.Environment.manage():
            if dbname:
                ...
                with registry.cursor() as cr:
                    ...
                    ctx = tigernix.api.Environment(cr, uid, {})['res.users'].context_get()
                    env = tigernix.api.Environment(cr, uid, ctx)
                    local_vars['env'] = env
