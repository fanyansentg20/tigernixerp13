...
from tigernix.modules.module import get_module_root, MANIFEST_NAMES
from tigernix.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the TigernixERP server for your project"""
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            tigernix.tools.config['init']['base'] = True
