...
For now, configuration code is in tigernixerp.tools.config. It is in mainly
...
To initialize properly this module, tigernixerp.tools.config.parse_config()
must be used.

"""

# Paths to search for TigernixERP addons.
addons_paths = []
...
# installed (i.e. the majority of TigernixERP addons). This is set with the --load
# command-line option.
server_wide_modules = []
