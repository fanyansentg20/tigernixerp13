...
term representation was ['=', 'company_id.name', 'TigernixERP']. Used in a
...
TigernixERP will use the SQL function 'unaccent' when available for the
...
Finally, to instruct TigernixERP to really use the unaccent function, you have to
...
def get_unaccent_wrapper(cr):
    if tigernix.registry(cr.dbname).has_unaccent:
