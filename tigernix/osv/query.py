...
class Query(object):
    ...
    def _get_table_aliases(self):
        from tigernix.osv.expression import get_alias_from_query
    ...
    def add_join(self, connection, implicit=True, outer=False, extra=None, extra_params=[]):
        """ Join a destination table to the current table.
            ...
            :param implicit: False if the join is an explicit join. This allows
                ...
                TigernixERP 7.0. It therefore adds the JOIN specified in ``connection``
        ...
        """
        from tigernix.osv.expression import generate_table_alias
