...
"""
The PostgreSQL connector is a connectivity layer between the TigernixERP code and
...
from tigernix.api import Environment
...
class Cursor(object):
    """Represents an open transaction to the PostgreSQL DB backend,
       ...
       ``cursor`` objects.
        ...
        such as TigernixERP, we need the best guarantees that no data
        ...
        TigernixERP implements its own level of locking protection
        ...
        the default transaction isolation level for TigernixERP cursors, as
...
def close_db(db_name):
    """ You might want to call tigernix.modules.registry.Registry.delete(db_name) along this function."""
    global _Pool
    if _Pool:
