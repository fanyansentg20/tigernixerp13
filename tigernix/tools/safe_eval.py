...
TigernixERP domain strings, conditions and expressions, mostly based on locals
...
def safe_eval(expr, globals_dict=None, locals_dict=None, mode="eval", nocopy=False, locals_builtins=False):
    ...
    an TigernixERP domain expression from an untrusted source.
    ...
    except tigernix.exceptions.except_orm:
        raise
    except tigernix.exceptions.Warning:
        raise
    except tigernix.exceptions.RedirectWarning:
        raise
    except tigernix.exceptions.AccessDenied:
        raise
    except tigernix.exceptions.AccessError:
        raise
    except werkzeug.exceptions.HTTPException:
        raise
    except tigernix.http.AuthenticationError:
        raise
